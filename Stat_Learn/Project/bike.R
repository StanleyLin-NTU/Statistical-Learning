set.seed(9487)
data=read.csv('/Users/StanleyLIn/Downloads/Bike-Sharing-Dataset/day.csv',header=TRUE)
library(randomForest)
data=data[,-c(1,2,3,4,5,9,14,15)]
print(data)
numFold = 5
RMSE=c()
MAE=c()
...
for(i in 1:numFold)
{
	...
	a=randomForest(cnt~.,data=train,ntree=30,type=regression)

set.seed(9487)
data=read.csvset.seed(9487)
data=read.csv('/Users/StanleyLIn/Desktop/hardware.txt',header=FALSE)
print(dim(data))
data=data[,-c(1,2)]
data[data=="?"]<-NA
print(data)
...
for(i in 1:numFold)
{
	...
	a=randomForest(V10~.,data=train,ntree=30,type=regression)
...
print(mean(R_sqr))
print(mean(cors))
print(proc.time())('/Users/StanleyLIn/Desktop/hardware.txt',header=FALSE)
print(dim(data))
print(proc.time())